...
function MenuContent() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-blue-100 selection:text-blue-900 overflow-x-hidden">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-zinc-900 rounded-[1.25rem] flex items-center justify-center shadow-2xl relative overflow-hidden group">
              <div className="absolute inset-0 bg-amber-500 scale-0 group-hover:scale-100 " />
              <Image src="/logo-splash.jpeg" alt="Logo" width={66} height={66} priority className="relative z-10  object-cover" />
            </div>
            <div>
              <h1 className="font-serif font-semibold text-2xl tracking-tight leading-none text-zinc-900">The <span className="text-blue-950">Bliss</span></h1>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-40">
            <div className="relative w-20 h-20 mb-8">
              <div className="absolute inset-0 border-4 border-blue-50 border-t-blue-950 rounded-full animate-spin" />
          ...
          <div className="text-center py-32 px-8">
            ...
            <button
              ...
              className="mt-10 bg-blue-50 text-blue-950 px-8 py-4 rounded-[2rem] font-serif font-semibold text-sm uppercase tracking-widest hover:bg-blue-100 transition-all flex items-center gap-3 mx-auto active:scale-95"
            >
              ...
              groupedItems.map((group) => (
                <div key={group.category._id} className="space-y-10 group/section">
                  <div className="flex items-center gap-6">
                    <h3 className="text-4xl font-serif font-semibold tracking-tight text-zinc-900 group-hover/section:text-blue-950 transition-colors uppercase leading-[0.8]">{group.category.name}</h3>
                    <div className="h-[2px] flex-1 bg-zinc-50 group-hover/section:bg-blue-50 transition-colors"></div>
                    <span className="text-[10px] font-black text-zinc-300 uppercase tracking-[0.3em] group-hover/section:text-blue-300 transition-colors">{group.items.length} OPTIONS</span>
                  </div>
      ...
      {/* Premium Footer */}
      <footer className="p-16 bg-[#021d4f] text-center space-y-8 relative overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center gap-4 relative z-10">
          <div className="w-24 h-24 rounded-2xl overflow-hidden flex items-center justify-center shadow-2xl border border-white/10 group">
            <Image src="/logo-splash.jpeg" alt="The Bliss Palampur" width={96} height={96} priority className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
          </div>
          <span className="font-serif font-semibold text-2xl text-white tracking-tight">The <span className="text-amber-500">Bliss</span></span>
        </div>
        <p className="text-blue-100/70 text-sm max-w-xs mx-auto leading-relaxed relative z-10 font-serif italic">
        ...
        <div className="pt-8 flex flex-col items-center justify-center gap-1 relative z-10">
          <div className="text-[10px] font-semibold text-amber-500/60 uppercase tracking-[0.5em] mb-2">SERVICE HOURS</div>
          <div className="text-white font-serif font-semibold text-xl tracking-tight">8:00 AM — 10:00 PM</div>
          <div className="w-2 h-2 bg-amber-500 rounded-full animate-pulse mt-4 shadow-[0_0_15px_rgba(245,158,11,0.5)]" />
        </div>
      </footer>
